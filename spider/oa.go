...
func ZenodoSpider(doi, proxy string, timeout int) (urls []string) {
...
func CshlpSpider(doi, proxy string, timeout int) (urls []string) {
	host := ""
...
func BiomedcentralSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func PnasSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func PlosSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
	...
	c.OnHTML(".supplementary-material a[href]", func(e *colly.HTMLElement) {
		link := e.Attr("href")
		//if strings.Contains(link, "supplementary") && stringo.StrDetect(link, "^/") {
		//	link = "https://journals.plos.org" + link
		//} else if strings.Contains(link, "supplementary") && !stringo.StrDetect(link, "^/") {
		//	link = "https://journals.plos.org/" + link
		//}
...
func FrontiersinSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func PeerjSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func OupComSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func EmbopressSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func AscopubsSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func HaematologicaSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func WileyComSpider(doi, proxy string, timeout int) (urls []string) {
	host := "https://onlinelibrary.wiley.com"
	if strings.Contains(doi, "10.1002/hep.") {
...
func ElifeSpider(doi, proxy string, timeout int) (urls []string) {
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
...
func JciSpider(doi, proxy string, timeout int) (urls []string) {
...
func JstatsoftSpider(doi, proxy string, timeout int) (urls []string) {
	// host := "https://www.jstatsoft.org"
	// Instantiate default collector
	c := colly.NewCollector(
		// Visit only domains: hackerspaces.org, wiki.hackerspaces.org
