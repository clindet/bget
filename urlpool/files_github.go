...
var githubRepos = []bgetFilesURLType{
	...
	{
		Name:         "htslib",
		URL:          []string{"https://github.com/samtools/htslib"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
		Name:         "bowtie",
	...
	{
		Name:         "trinityrnaseq",
		URL:          []string{"https://github.com/trinityrnatrinityrnaseq"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
		Name:         "oases",
	...
	{
		Name:         "conbase",
		URL:          []string{"https://github.com/conconbase"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
		Name:         "3dchromatin-replicateqc",
	...
	},
	{
		...
		URL:          []string{"https://github.com/maize-genetics-and-genomics-datamaizedig"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
	...
	},
	{
		...
		URL:          []string{"https://github.com/maize-genetics-and-genomics-datapedigreenet"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
	...
	{
		Name:         "github/janus",
		URL:          []string{"https://github.com/ccjanus"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
	...
	},
	{
		...
		URL:          []string{"https://github.com/qiaqiaseq-dna"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
	...
	},
	{
		...
		URL:          []string{"https://github.com/ngvirapipe"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
	...
	},
	{
		...
		URL:          []string{"https://github.com/bitbitseqvb_benchmarking"},
		PostShellCmd: []string{"cd {{dest}} && git checkout {{version}}"},
	},
	{
