...
var otherFiles = []bgetFilesURLType{
	...
	},
	{
		...
		Versions: []string{"0.11.5", "0.11.4", "0.11.3", "0.11.2", "0.11.1", "0.10.1", "0.10.0", "0.9.6", "0.9.5", "0.9.4", "0.9.3", "0.9.2", "0.9.1", "0.9.0", "0.8.0", "0.7.2", "0.7.1", "0.7.0", "0.6.1", "0.6.0", "0.5.1", "0.5.0", "0.4.3", "0.4.2", "0.4.1", "0.4", "0.3.1", "0.3", "0.2", "0.1.1", "0.1"},
	},
	{
		Name:     "fusioncatcher",
	...
	{
		Name: "htslib",
		URL:  []string{"https://codeload.github.com/samtools/htslib/tar.gz/{{version}}"},
	},
	{
		Name:     "igv",
	...
	{
		Name: "samtools",
		URL:  []string{"https://codeload.github.com/samtools/samtools/tar.gz/{{version}}"},
	},
	{
		Name:     "snpeff",
